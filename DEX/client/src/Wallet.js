...
const toEther = new BigNumber(1000000000000000000);
      ...
      <div className="form-group row">
        ...
        <div className="col-sm-8">
          <input 
            ...
            id="wallet" 
            disabled 
            value={user.balances.tokenWallet / toEther}
          />
        </div>
      </div>
      <div className="form-group row">
        ...
        <div className="col-sm-8">
          <input 
            ...
            id="wallet" 
            disabled 
            value={user.balances.tokenDex / toEther}
          />
        </div>
      </div>
          ...
          <div className="col-sm-8">
            <div className="input-group mb-3">
              <input 
                ...
                type="text" 
                className="form-control" 
                onChange={(e) => setAmount( new BigNumber(e.target.value * toEther) )}
              />
